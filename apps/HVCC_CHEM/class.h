...
public:
	...
	void writeAscii(FILE* fp) const {
		//17
		fprintf(fp, "%lld\t%.16e\t%.16e\t%.16e\t%.16e\t%.16e\t%.16e\t%.16e\t%.16e\t%.16e\t%.16e\t%.16e\t%.16e\t%.16e\t%.16e\t%.16e\t%.16e\n", this->id, this->mass, this->pos.x, this->pos.y, this->pos.z, this->vel.x, this->vel.y, this->vel.z, this->dens, this->eng, this->pres, this->MagneticB.x,
				this->MagneticB.y, this->MagneticB.z, this->vel.x, this->vel.y, this->vel.z);
	}
	/*
